import { View, Text, Dimensions,Image,TouchableOpacity, StyleSheet,  ScrollView, ImageBackground } from "react-native";
 ...
 return (
  <View style={styles.container}>
    <View style={styles.header}>
      ...
      <MaskedView
         maskElement={
         <Text style={{textAlign: "center",fontWeight: "bold",fontSize: 30}}>FickleFlight</Text>
         }>
        <LinearGradient
         style={styles.logo}
         locations={[0, 1]}
    ...
    <ScrollView keyboardShouldPersistTaps="always">
      <View style={styles.parisCard}>
        <ImageBackground source={require('../assets/paris.jpg')} style={styles.backgroundImage}>
          ...
          <View>
            <View style={{alignItems: "flex-end",justifyContent: "flex-end", paddingHorizontal: 10,}}>
              <Text style={{color: "#ffffff", fontFamily: "Inter-400", fontSize: 14, lineHeight: 17}}>FROM</Text> 
            </View>
            <View style={{paddingHorizontal: 10,paddingBottom: 5, display: "flex", flexDirection: "row",alignItems:"flex-start", justifyContent: "space-between"}}>
              <View style={{display: "flex", flexDirection: "row", alignItems: "center"}}>
                <Text style={{color: "#ffffff",fontFamily: "Baloo-Bhai-2", fontSize: 28, lineHeight: 45}}>Paris</Text>
              ...
              <Text style={{color: "#ffffff",fontFamily: "Baloo-Bhai-2", fontSize: 32, lineHeight: 51}}>$1299</Text> 
            </View>
          </View>
        </ImageBackground> 
      </View>
     ...
     <View style={{paddingHorizontal: "5%"}}>
       <Text style={{fontSize: 16, fontFamily: "Inter-700", lineHeight: 24}}>upcoming Flight</Text>
        <View style={{backgroundColor: "#ffffff", padding: 10, marginVertical: 10, borderRadius: 10}}>
          <View style={{display: 'flex', flexDirection: "row", alignItems: "center", gap: 20}}>
            <View style={{flex: 1}}>
              <Text style={{color: "#1262AE", fontSize: 20, fontFamily: "Inter-700", lineHeight: 24}}>SIN</Text>
              <Text style={{fontSize: 14, fontFamily: "Inter-400", lineHeight: 18}}>Singaphore</Text>
            </View>
          ...
          <View style={{flex: 1, alignItems: 'flex-end'}}>
            <Text style={{color: "#1262AE", fontSize: 20, fontFamily: "Inter-700", lineHeight: 24}}>LAX</Text>
            <Text style={{fontSize: 14, fontFamily: "Inter-400", lineHeight: 18}}>Los angelos</Text>
          </View>
        </View>
        <View style={{borderBottomWidth: 1, borderBottomColor: "#F5F6F8",marginVertical: 10}}/>
        <View style={{display: "flex", flexDirection: "row", justifyContent:"space-between", alignItems: "center"}}>
          <Text style={{fontSize: 15, fontFamily: "Robot-500", color: "#7E8B97", lineHeight: 18}}>Depart on: 1 may, 8:00 am</Text>
          <Text style={{fontSize: 15, fontFamily: "Inter-400", color: "#7E8B97", lineHeight: 18}}>
            <Text style={{fontFamily: "Inter-700"}}>4 days </Text>
             to go
          </Text>
        </View>
      </View>
     ...
     <View style={{padding: "5%"}}>
       <View style={{display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
         <Text style={{fontSize: 16, fontFamily: "Inter-700", lineHeight: 24}}>Trending Destination</Text>
         <TouchableOpacity onPress={()=>setVisible1(true)}>
           <Text style={{color: "#1262AE", fontFamily: "Inter-400", lineHeight: 18}}>See all</Text>
         </TouchableOpacity>
       </View>
