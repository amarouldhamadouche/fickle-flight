 ...
 return (
  <View style={StyleSheet.container}>
    ...
    <View style={{position: "relative", backgroundColor: "white", marginTop: -10,borderTopRightRadius:10, borderTopLeftRadius:10, height: Dimensions.get("window").height * 0.64, paddingHorizontal: 15}}>
      ...
      <Text style={{fontSize: 24, fontFamily: "Inter-700", color: "#191919", marginTop: 42, lineHeight: 29}}>
        Macy jonson
      </Text>
      <Text style={{color: "#7E8B97", fontFamily: "Inter-400", fontSize: 14, lineHeight: 17}}>
        baguio, philippines
      </Text>
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="always" style={{paddingBottom: 10}}>
      <Text style={{color: "#191919", marginTop: 10, fontFamily: "Inter-400", fontSize: 14, lineHeight: 24}}>
      ...
      <TouchableOpacity style={{display: "flex", flexDirection: "row", alignItems: "center",marginVertical: 10}}>
        ...
        <Text style={{fontSize: 16, fontFamily: "Robot-500", lineHeight: 24}}>Payment Details</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{display: "flex", flexDirection: "row", alignItems: "center",marginVertical: 10}}>
        <View style={{padding: 5, backgroundColor: "#F1F7FD", marginRight: 15}}>
          <FontAwesome5 name="shield-virus" size={20} color="#1262AE"/>
        </View>
        <Text style={{fontSize: 16, fontFamily: "Robot-500", lineHeight: 24}}>Covid Advisory</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{display: "flex", flexDirection: "row", alignItems: "center",marginVertical: 10}}>
        <View style={{padding: 5, backgroundColor: "#F1F7FD", marginRight: 15}}>
          <Ionicons name="person-outline" size={20} color="#1262AE"/>
        </View>
        <Text style={{fontSize: 16, fontFamily: "Robot-500", lineHeight: 24}}>Referal Code</Text>
        <View style={{backgroundColor: "#32D4AD", marginLeft: 15, paddingHorizontal: 5, borderRadius: 5}}>
          <Text style={{color: "white",fontSize: 13, fontFamily: "Robot-500"}}>New</Text>
        </View>
      </TouchableOpacity>
      <TouchableOpacity style={{display: "flex", flexDirection: "row", alignItems: "center",marginVertical: 10}}>
        <View style={{padding: 5, backgroundColor: "#F1F7FD", marginRight: 15}}>
        ...
        <Text style={{fontSize: 16, fontFamily: "Robot-500", lineHeight: 24}}>Settings</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{display: "flex", flexDirection: "row", alignItems: "center",marginVertical: 10}}>
        <View style={{padding: 5, backgroundColor: "#F1F7FD", marginRight: 15}}>
          <AntDesign name="logout" size={20} color="#1262AE"/>
        </View>
        <Text style={{fontSize: 16, fontFamily: "Robot-500", lineHeight: 24}}>Logout</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{backgroundColor: "#EAF5FF", paddingVertical: 10, display: "flex",flexDirection: "row", alignItems: "center", justifyContent: "center"}}>
        ...
        <Text style={{marginLeft: 15,color: "#1262AE", fontFamily: "Inter-400", lineHeight: 24}}>
